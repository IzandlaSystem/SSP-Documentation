...
function buildFirmwareSidebar(): SidebarGroup[] {
  ...
  const ordered = [
    ...
    'zephyr-rtos.md',
    'bootloader-dfu.md',
    'ota-integration-plan.md',
    'hal-drivers.md',
    'build-flash-debug.md',
    'dual-firmware-build.md',
    'ble-services.md',
    'gnss-ubx.md',
    'mobile-protocol.md',
    'app-integration-blockers-and-requests.md',
    'power-management.md',
    'sensor-fusion.md',
    'sport-modes.md',
    'phase1.md',
  ...
  '/projects/backend/': [
    {
      ...
      items: [
        ...
        { text: 'Architecture', link: '/projects/backend/architecture' },
        { text: 'Auth & Security', link: '/projects/backend/auth-and-security' },
        { text: 'Database Schema', link: '/projects/backend/database-schema' },
        { text: 'Client Contract', link: '/projects/backend/client-contract' },
        { text: 'API Reference', link: '/projects/backend/api-reference' },
        { text: 'Firmware OTA', link: '/projects/backend/firmware-ota' },
        { text: 'Ingestion Pipeline', link: '/projects/backend/ingestion-pipeline' },
      ],
    },
    {
      text: 'Phase 1 Core Routes',
      items: [
        { text: 'Users & Identity', link: '/projects/backend/routes/users' },
        { text: 'Organisations', link: '/projects/backend/routes/organisations' },
        { text: 'Teams & Rosters', link: '/projects/backend/routes/teams' },
        { text: 'Athletes', link: '/projects/backend/routes/athletes' },
        { text: 'Coaches', link: '/projects/backend/routes/coaches' },
        { text: 'Devices & Pairing', link: '/projects/backend/routes/devices' },
        { text: 'Sessions & Lifecycle', link: '/projects/backend/routes/sessions' },
        { text: 'Metrics & Targets', link: '/projects/backend/routes/metrics' },
        { text: 'Workload & ACWR', link: '/projects/backend/routes/workload' },
        { text: 'Goals', link: '/projects/backend/routes/goals' },
        { text: 'Benchmarks', link: '/projects/backend/routes/benchmarks' },
        { text: 'Notifications', link: '/projects/backend/routes/notifications' },
        { text: 'Analytics', link: '/projects/backend/routes/analytics' },
      ],
    },
    {
      text: 'Phase 3 Routes',
      items: [
        { text: 'Firmware Releases', link: '/projects/backend/routes/firmware-releases' },
        { text: 'Internal & Workers', link: '/projects/backend/routes/internal' },
      ],
    },
  ],
